...
- Fix Envelope::unit() to create KnownValue case instead of Leaf case

### 0.41.0 - January 11, 2026

- Align to dependencies
- Add support for known-values directory loading feature

### 0.40.0 - December 19, 2025

- Align to dependencies.
- Add `Eq` derives to `Envelope`, `EnvelopeCase`, and `Attachments`.

### 0.39.0 - December 4, 2025
...
- Add walk_replace() method for replacing nodes by digest.
...
- Remove all dependency on anyhow.
- Align to dependencies.
