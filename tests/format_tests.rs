                ...
                ASSERTION
                    ...
                    "Atlas Shrugged"
                        ASSERTION
                            ...
                            "en"
    "#}.trim());
    assert_eq!(book_metadata.elements_count(), book_metadata.tree_format(false).split('\n').count());
}
...
fn test_redacted_credential() {
    ...
    target.extend(content.assertion_with_predicate(known_values::ISSUER).unwrap().shallow_digests());
