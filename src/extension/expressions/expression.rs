...
impl Expression {
    ...
    pub fn with_optional_parameter(self, parameter: impl Into<Parameter>, value: Option<impl EnvelopeEncodable>) -> Self {
...
mod tests {
    ...
    fn test_expression_1() -> Result<()> {
        ...
        assert_eq!(parsed_expression.envelope(), expression.envelope());
