...
use bc_components::{PrivateKeyBase, PublicKeyBase, CID, SymmetricKey, Nonce};
use hex_literal::hex;
...
pub fn bob_identifier() -> CID { CID::from_data(hex!("d44c5e0afd353f47b02f58a5a3a29d9a2efa6298692f896cd2923268599a0d0f")) }
...
pub fn carol_identifier() -> CID { CID::from_data(hex!("06c777262faedf49a443277474c1c08531efcff4c58e9cb3b04f7fc1c0e6d60d")) }
...
pub fn example_ledger_identifier() -> CID { CID::from_data(hex!("0eda5ce79a2b5619e387f490861a2e7211559029b3b369cf98fb749bd3ba9a5d")) }
...
pub fn state_identifier() -> CID { CID::from_data(hex!("04363d5ff99733bc0f1577baba440af1cf344ad9e454fad9d128c00fef6505e8")) }
